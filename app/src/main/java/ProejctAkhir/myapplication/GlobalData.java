...
public class GlobalData {
    ...
    public ArrayList<Game> createGame () {
       ...
       // Type Mobile
       Game pubg = new Game("PUBG Mobile", "Experience the intense battle royale action in PUBG Mobile", "mobile", R.drawable.img_game);
       ...
       Game stumbleGuys = new Game("Stumble Guys", "Join the hilarious race with funny characters in Stumble Guys", "mobile", R.drawable.img_game);
       ...
       Game hayDay = new Game("HayDay", "Build and manage your dream farm in the charming world of HayDay", "mobile", R.drawable.img_game);
       ...
       Game clashRoyale = new Game("Clash Royale", "Enter the epic Clash Royale arena and battle with your favorite cards", "mobile", R.drawable.img_game);
       ...
       Game amongUs = new Game("Among Us", "Unmask the impostors in the thrilling social deduction game Among Us", "Mobile", R.drawable.img_game);
       ...
       // Type PC
       Game valorant = new Game("Valorant", "Join the tactical first-person shooter Valorant and become a skilled agent", "PC", R.drawable.img_game);
       ...
       Game gta = new Game("GTA", "Experience the open-world adventure in the action-packed game GTA", "PC", R.drawable.img_game);
       ...
       Game minecraft = new Game("Minecraft", "Explore the blocky world and unleash your creativity in Minecraft", "PC", R.drawable.img_game);
       ...
       Game fortNite = new Game("FortNite", "Enter the battle royale madness in the popular game FortNite", "PC", R.drawable.img_game);
       ...
       Game asphalt = new Game("Asphalt", "Experience high-speed racing action in the thrilling Asphalt series", "PC", R.drawable.img_game);
       ...
       // Type Console
       Game mariokart = new Game("Mariokart", "Race with iconic characters in the thrilling Mariokart series", "Console", R.drawable.img_game);
       ...
       Game fifa23 = new Game("Fifa23", "Play as your favorite soccer stars in the exciting game Fifa23", "Console", R.drawable.img_game);
       ...
       Game marioBros = new Game("MarioBros", "Relive the classic adventures with the iconic MarioBros", "Console", R.drawable.img_game);
       ...
       Game pikmin = new Game("Pikmin", "Embark on a thrilling adventure with the adorable Pikmin", "Console", R.drawable.img_game);
       ...
       Game pokemon = new Game("Pokemon", "Catch and train a variety of Pokémon in the legendary Pokemon series", "Console", R.drawable.img_game);
