...
public class GlobalData {
    ...
    public ArrayList<Game> createGame () {
       ...
       // Type Mobile
       Game pubg = new Game("PUBG Mobile", "Experience the intense battle royale action in PUBG Mobile", "mobile", 1);
       ...
       Game stumbleGuys = new Game("Stumble Guys", "Join the hilarious race with funny characters in Stumble Guys", "mobile", 1);
       ...
       Game hayDay = new Game("HayDay", "Build and manage your dream farm in the charming world of HayDay", "mobile", 1);
       ...
       Game clashRoyale = new Game("Clash Royale", "Enter the epic Clash Royale arena and battle with your favorite cards", "mobile", 1);
       ...
       Game amongUs = new Game("Among Us", "Unmask the impostors in the thrilling social deduction game Among Us", "Mobile", 1);
       ...
       // Type PC
       Game valorant = new Game("Valorant", "Join the tactical first-person shooter Valorant and become a skilled agent", "PC", 1);
       ...
       Game gta = new Game("GTA", "Experience the open-world adventure in the action-packed game GTA", "PC", 1);
       ...
       Game minecraft = new Game("Minecraft", "Explore the blocky world and unleash your creativity in Minecraft", "PC", 1);
       ...
       Game fortNite = new Game("FortNite", "Enter the battle royale madness in the popular game FortNite", "PC", 1);
       ...
       Game asphalt = new Game("Asphalt", "Experience high-speed racing action in the thrilling Asphalt series", "PC", 1);
       ...
       // Type Console
       Game mariokart = new Game("Mariokart", "Race with iconic characters in the thrilling Mariokart series", "Console", 1);
       ...
       Game fifa23 = new Game("Fifa23", "Play as your favorite soccer stars in the exciting game Fifa23", "Console", 1);
       ...
       Game marioBros = new Game("MarioBros", "Relive the classic adventures with the iconic MarioBros", "Console", 1);
       ...
       Game pikmin = new Game("Pikmin", "Embark on a thrilling adventure with the adorable Pikmin", "Console", 1);
       ...
       Game pokemon = new Game("Pokemon", "Catch and train a variety of Pokémon in the legendary Pokemon series", "Console", 1);
